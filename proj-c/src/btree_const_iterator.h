#ifndef ROMZ_BTREE_CONST_ITERATOR_H
#define ROMZ_BTREE_CONST_ITERATOR_H
...
public:
    ...
    inline btree_const_iterator()
        : currnode(nullptr), currslot(0)
    { }

    /// Initializing-Constructor of a const iterator
    inline btree_const_iterator(const typename btree_const_iterator::leaf_node* l, size_type s)
        : currnode(l), currslot(s)
    { }

    /// Copy-constructor from a mutable iterator
    inline btree_const_iterator(const btree_iterator< _Key,
                                 _Data,
                                 _Value,
                                 _Compare,
                                 _Traits,
    ...
    inline btree_const_iterator(const btree_reverse_iterator< _Key,
                                _Data,
                                _Value,
                                _Compare,
                                _Traits,
    ...
    inline btree_const_iterator(const btree_const_reverse_iterator< _Key,
                                _Data,
                                _Value,
                                _Compare,
                                _Traits,
    ...
    inline btree_const_iterator& operator ++ ()
    {
    ...
    inline btree_const_iterator operator ++ (int)
    {
        btree_const_iterator tmp = *this;   // copy ourselves
    ...
    inline bool operator == (const btree_const_iterator& x) const
    {
